...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->artifact_entity.ModelEvaluationArtifact:
        try:
            ...
            previous_model_score = recall_score(y_true=y_true, y_pred=y_pred)
            ...
            current_model_score = recall_score(y_true=y_true, y_pred=y_pred)
            ...
            model_eval_artifact = artifact_entity.ModelEvaluationArtifact(is_model_accepted=True,
            is_accuracy_improved=current_model_score-previous_model_score)
